...
var ScopeService = /** @class */ (function () {
    ...
    ScopeService.prototype.getScopes = function (username) {
        return __awaiter(this, void 0, void 0, function () {
            var DBImpl, scopes, e_1;
    ...
    ScopeService.prototype.addScope = function (username, scope) {
        return __awaiter(this, void 0, void 0, function () {
            var DBImpl, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, DBImpl.addScope(username, scope)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    ScopeService.prototype.removeScope = function (username, scope) {
        return __awaiter(this, void 0, void 0, function () {
            var DBImpl, e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, DBImpl.removeScope(username, scope)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
